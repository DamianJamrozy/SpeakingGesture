...
<div class="content">
    <div class="container">
        <div class="hero">
            <span class="button-v1 transparent"> 6 gestów - 1100 próbek - ponad 1h nagrań  </span>
        ...
        <div>
            ...
            <div class="glow-circle">
                <h2>Nasz program to<br> nie tylko zera i<br> jedynki!</h2>

                <p>Aplikacja Speaking Gesture składa się z<br>
                zaawansowanych algorytmów uczenia maszynowego<br>
                w oparciu o sieci neuronowe.</p>
            </div>
